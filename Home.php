...
<body>
  ...
  <button onclick="goTo('contactUs')">Contact Us</button>

  <?php if (isset($_SESSION["User_logged_in"]) && $_SESSION["User_logged_in"] === "Yes" && $currentPage === "dashboard"): ?>
  ...
  <section class="hero">
    <h2>Meet Our Tailors</h2>
    <div class="gallery">
      <img src="pic1.jpg" alt="Tailor 1">
      <img src="pic2.jpg" alt="Tailor 2">
      <img src="pic3.jpg" alt="Tailor 3">
      <img src="pic4.jpg" alt="Tailor 4">
    </div>
  </section>
